...
import com.bpd.arsip.helper.render.TableQuotaRakRender;
...
public class RakModel {
    ...
    @TableColumn(name = "ID RAK", number = 1, size = 30 , renderer = TableRenderDefault.class)
    private String idRak;
    @TableColumn(name = "NAMA RAK", number = 2, size = 60, renderer = NamaRakRender.class)
    private int namaRak;
    @TableColumn(name = "QUOTA RAK", number = 3, size = 50, renderer = TableQuotaRakRender.class)
    private int quota;
